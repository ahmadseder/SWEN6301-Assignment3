...
public class RandomUtils {
    ...
    /**
     * Generates a random {@link BloodType} for blood type.
     *
     * @return a random blood type {@link BloodType}.
     */
    public static BloodType randomBloodType() {
        BloodType[] bloodTypes = BloodType.values();
        int randomIndexFromBloodType = RANDOM.nextInt(bloodTypes.length - 1);
        return bloodTypes[randomIndexFromBloodType];
    }
